#include "pch.h"
//#include "ParticalRenderer.h"
//#include "Alalba_VK/Core/Application.h"
//#include "Alalba_VK/Core/Scene/Entity.h"
//
//namespace Alalba
//{
//	ParticalRenderer::ParticalRenderer(Scene& scene)
//		:m_scene(scene)
//	{
//		Application& app = Application::Get();
//		const vk::Device& device = app.GetDevice();
//
//		m_allocator.reset(new vk::Allocator(device, app.GetVulkanInstance(), "ParticalRenderer Allocator"));
//		
...
//			.SetTag("ParticalRenderer CmdPool")
...
//	}
//	void ParticalRenderer::Shutdown()
//	{
...
//
//	}
//	void ParticalRenderer::PrepareCommandBuffers()
//	{
//	
//		for (int i = 0; i < vk::SwapChain::MAX_FRAMES_IN_FLIGHT; i++)
//		{
...
//	}
//
//	void ParticalRenderer::UpdateCommandBuffer(uint32_t currentFrame)
//	{
...
//
//
//			///  On screen using ParticalRenderer's renderpass
//			if (m_DeugSysOn)
...
//	}
//
//	void ParticalRenderer::Update(Scene& scene)
//	{
//		// update camera
...
//	}
//
//	void ParticalRenderer::DrawFrame(Scene& scene)
//	{
//		Application& app = Application::Get();
//		const vk::Device& device = app.GetDevice();
//
...
//		}*/
//
//		//std::vector<vk::Semaphore> currentWait;
//		//currentWait.push_back(*m_imageAvailableSemaphores[m_currentFrame]);
//
//		//std::vector<vk::Semaphore> currentSignal;
//		//currentSignal.push_back(*m_renderFinishedSemaphores[m_currentFrame]);
//		
